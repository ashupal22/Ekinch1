...
const Add_project = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:5000/project-submit', formData)
      .then((response) => {
            ...
            <div className="col-xl-12">
              <div className="card">
                <div className="card-body frm_space">
                  ...
                  <form method="post" action="/project-submit" onSubmit={handleSubmit} className="custom-validation font-14">
                    <div className="mb-0">
                    ...
                    <div className="input-group mb-3">
                      ...
                      <input name="project_id" type="text" className="form-control" required data-parsley-maxlength="6" placeholder="Project-ID" onChange={handleInputChange} />
                    </div>

                    <div className="mb-3">
                      <label>Name of the project* :</label>
                      <div>
                        <input type="text" name="project_name" className="form-control" required data-parsley-minlength="6" placeholder="Enter project name" onChange={handleInputChange} />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <select name="project_city" className="form-select" onChange={handleInputChange}>
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <select name="project_district" className="form-select" onChange={handleInputChange}>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <select name="project_state" className="form-select" onChange={handleInputChange}>
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <input type="number" name="project_pincode" className="form-control" required data-parsley-maxlength="6" placeholder="Enter pincode" onChange={handleInputChange} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      ...
                      <div>
                        <input type="text" name="project_cost" className="form-control" required data-parsley-maxlength="6" placeholder="Enter project cost" onChange={handleInputChange} />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <input type="text" name="actual_cost" className="form-control" required data-parsley-maxlength="6" placeholder="Enter actual cost" onChange={handleInputChange} />
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="formrow-password-input" className="form-label"></label>
                          <input type="text" name="bit_cost" className="form-control mt-2" required data-parsley-maxlength="6" placeholder="Enter bit cost" onChange={handleInputChange} />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <div className="input-group" id="datepicker1">
                            <input type="number" name="startDate" id="birthday" className="form-control" placeholder="DD-MM-YYYY" title="Please enter a date in the format DD-MM-YYYY" onChange={handleInputChange} />
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <div className="input-group" id="datepicker1">
                            <input type="number" name="endDate" id="birthday" className="form-control" placeholder="DD-MM-YYYY" title="Please enter a date in the format DD-MM-YYYY" onChange={handleInputChange} />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      ...
                      <div>
                        <select name="project_agency" className="form-select" onChange={handleInputChange}>
